// LEGADO: módulo de gestão de alunos baseado em localStorage, mantido para compatibilidade e testes.
// A versão em produção utiliza alunos-mysql.js integrado ao backend MySQL.
